...
async function clearDrafts() {
  await game.settings.set("op5e-character-creator", "drafts", {});
}
...
export async function runWizardFormTest() {
  ...
  assert(Wizard, "game.op5eCharacterCreator.WizardApp is unavailable. Enable op5e-character-creator.");
  ...
  const draft = Object.values(game.settings.get("op5e-character-creator", "drafts") ?? {})[0];
