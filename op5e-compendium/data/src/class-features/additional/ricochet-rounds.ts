...
export const ricochetRoundsFeatures: FeatureItem[] = [
  feat(
    "additional-power/ricochet-rounds",
    "Ricochet Rounds",
    `<p>You learn to reclaim the potential of any of your stray shots, causing them to bounce around in odd patterns to strike another foe.</p>`,
    { requirements: "" },
  ),
  feat(
    "additional-power/ricochet-rounds/rebound-bound",
    "Rebound Bound",
    `<p>Once per turn, when you make an attack roll with a ranged or thrown weapon, you can choose to reroll the attack roll against a different target within 30 feet of the original target.</p>`,
    {
      requirements: "Ricochet Rounds",
