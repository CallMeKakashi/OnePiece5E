...
| ~~`Characters/Baptiste` vs World Baptiste~~ | **Split:** PC in `Characters/Baptiste`; unit NPC renamed `Baptiste (Blackhand unit)` |
| ~~Composite timeline backstory~~ | **Split** into Elizabeth Marrow + Cane notes; PC prose merged into `Characters/Baptiste` |
