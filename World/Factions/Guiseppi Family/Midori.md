...
foundry_actor_id: "Yc3DVf7tPevq09Vj"
foundry_live_slug: "midori"
---
## Visuals

*Portrait quarry — [[Discord/exports/character-art]] (`Midori_Taro.jpg`)*

## Description

Fishman from CragHammer. Capable but unknown — new blood still finding his place in a world of syndicates and crew politics.

## Role

Associate of the [[Guiseppi Family]] as of the Juniper / York Town arc. Outsider integrating into local dynamics; paired with [[Matthew -The Jack- Burgess|Jack]] for clinic, tavern, and investigation beats when the main [[Lunarfolds]] roster is split.

**Table play:** Slew the **[[Hydra Goose]]** on a **West Town** farm (Lunafang fertilizer incident) with [[Tray]] and [[Jack]]; children rescued (transcript pending).
...
(To be developed — clinic morning with [[Linus Marrow]]; Baptiste's injured friend; York Town threads in [[Sessions/Session 28]].)
...
- [[Linus Marrow]]
- [[Baptiste]]
- [[Sessions/Session 27]] · [[Sessions/Session 28]]
## Live sheet (Foundry)
...
- name: Scroll Case full of Blueprints
  desc: "Map of Shortcuts At rank 3, your map case becomes a common magic item. In addition to storing normal maps, your cartographer's map case can be used to generate a special map identifying a shortcut. You can use your action to make a DC 15 Wisdom check, with a success revealing a map buried in your cartographer's map case noting a relevant shortcut . Your travel time is reduced by half while you follow that route. If you succeed at the check by 5 or more, the map includes no..."
