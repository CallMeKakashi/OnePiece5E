...
actions:
- name: Palm Laser Cannon
  desc: "A high-energy laser emitter built into the Enforcer's gauntlet. Ranged Weapon Attack: +7 to hit. Hit: 3d10 radiant"
- name: Power Gauntlet
  desc: "A powered strike from the armor's reinforced combat gauntlet. Melee Weapon Attack: +7 to hit. Hit: 2d8+4 bludgeoning"
- name: Overcharge Beam
