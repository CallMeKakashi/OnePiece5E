...
foundry_actor_id: "aNHJmn62dfKMPlhq"
foundry_live_slug: "malak-samum"
---
## Visuals

*Portrait pending re-download — [[Discord/exports/character-art]] (`Malak.png`)*

## Description

Doctor of the [[Braveheart Pirates]].
...
- name: Rapier
  desc: A thin tensile metal blade, light in weight but long in reach designed for quick darting attacks to target weak points in enemy defenses with lightning swiftness.
- name: Shortbow
  desc: This two handed bow is somewhat smaller than the traditional longbow variant, making it well suited for rapid attacks while on the move or mounted from horseback.
- name: Arrow
  desc: Standard ammunition used for bows of all varieties. These mundane arrows are made of smooth wooden shafts with goose feather fletching and hammer metal bodkins.
- name: Quiver
...
- name: Piton
  desc: A metal spike that is drive into a seam in a climbing surface with a climbing hammer. It can also be used like iron spikes to block doors in a pinch.
- name: Hammer
  desc: A tool with a heavy metal head mounted at the end of its handle, used for jobs such as breaking things and driving in nails.
- name: Leather Armor
...
- name: Rogue
  desc: "DescriptionA scoundrel who uses and trickery to overcome obstacles and enemiesHit Die: d8Primary Ability: DexteritySaves: Dexterity & IntelligenceClass FeaturesLevel 1: Hit PointsHit Dice: 1d8 per rogue levelHit Points at 1st Level: 8 + your Constitution modifierHit Points at Higher Levels: 1d8 (or 5) + your Constitution modifier per rogue level after 1stLevel 1: ProficienciesArmor: Light armorWeapons: Simple weapons, hand crossbows, longswords, rapiers, shortswordsTools: ..."
- name: Sneak Attack
  desc: "Beginning at 1st level, you know how to strike subtly and exploit a foe's distraction. Once per turn, you can deal an extra 1d6 damage to one creature you hit with an attack if you have advantage on the attack roll. The attack must use a finesse or a ranged weapon. You don't need advantage on the attack roll if another enemy of the target is within 5 feet of it, that enemy isn't incapacitated, and you don't have disadvantage on the attack roll. The amount of the extra dama..."
- name: "Thieves' Cant"
