...
- name: Thief
  desc: "DescriptionA scoundrel who uses and trickery to overcome obstacles and enemies Hit Die: d8Primary Ability: DexteritySaves: Dexterity & IntelligenceClass Features Starting at 3rd level, you can use the bonus action granted by your Cunning Action to make a Dexterity check, use your thieves' tools to disarm a trap or open a lock, or take the Use an Object action. When you choose this archetype at 3rd level, you gain the ability to climb faster than normal; climbing no longer ..."
- name: Fast Hands
  desc: "Starting at 3rd level, you can use the bonus action granted by your Cunning Action to make a Dexterity check, use your thieves' tools to disarm a trap or open a lock, or take the Use an Object action."
...
- name: "Heavy Metal Style: Thunder-Struck"
  desc: "Constitution Saving Throw: DC [[lookup @save.dc.value activity=Lq6GexegvlEVB6Dh]], each [[lookup @target.affects.type activity=Lq6GexegvlEVB6Dh]] in a [[lookup @target.template.size activity=Lq6GexegvlEVB6Dh]]-foot-radius Sphere centered on a point the [[lookup @name lowercase]] can see within [[lookup @range.value activity=Lq6GexegvlEVB6Dh]] feet.Failure: damage, and the target has the condition until the end of its next turn."
- name: Karambit
