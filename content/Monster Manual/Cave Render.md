...
status: draft
publish: true
foundry_actor_id: "NQiGWCArGHEH7Lux"
foundry_live_slug: "cave-render"
---
# Cave Render
...
Found in an **abandoned mine** near **York Town** (Juniper Islands).

## Appearances

- **Table play** — **Slain** by [[Thompson Caneheart]] and [[Matthew -The Jack- Burgess|Jack]]. Session note and transcript **not yet filed**.
