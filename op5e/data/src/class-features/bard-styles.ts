...
function style(
  ...
  return {
    _id: generateId(`feature/bard/style-${slug}`),
    ...
    system: {
      ...
      requirements: "Bard (College of Swords) 3",
...
export const bardStyles: FeatureItem[] = [
  style(
    "dueling",
    "Dueling",
    ...
    [createDAEEffect("bard/style-dueling", "Dueling", [addBonus("system.bonuses.mwak.damage", "2")])],
  ),
  style(
    "great-weapon",
