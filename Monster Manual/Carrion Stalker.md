...
status: draft
publish: true
foundry_actor_id: "z5HDS6EkjItemvCS"
foundry_live_slug: "carrion-stalker"
---
# Carrion Stalker
...
- **Table play** — Same encounter as the **[[Aberrant Abomination]]**; **slain** by [[B.O.B]], [[Roma]], and [[Tray]]. Session note and transcript **not yet filed**.
...
stats: [14, 18, 14, 6, 12, 6]
cr: 4
traits:
- name: Claw
  desc: "Melee Weapon Attack: +6 to hit. Hit: 1d8 @mod slashing. Ranged Weapon Attack: +4 to hit"
- name: Dive Strike
  desc: "If it moves 20 ft straight, deals extra 2d6 damage.. Ranged Weapon Attack: +4 to hit. Hit: 2d6. Hit: 1d8+2"
